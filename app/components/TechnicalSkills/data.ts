...
export const Sides: Record<SideList, { label: string; class: string }[]> = {
	[SideList.Frontend]: [
		...
		{ label: 'Yup', class: 'yup' },
		{ label: 'RHF', class: 'rhf' },
		{ label: 'Zustand', class: 'zustand' },
		{ label: 'Tanstack Query', class: 'tanstack-query' },
		{ label: 'Tanstack Router', class: 'tanstack-router' },
		{ label: 'Vitest', class: 'vitest' },
		{ label: 'Module Federation', class: 'mf' },
